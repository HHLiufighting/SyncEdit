...
def sample(
    input_path: str = "assets/4_TRELLIS_原始/007.png",  # Can either be image file or folder with image files
...
def get_batch(keys, value_dict, N, T, device):
    ...
    for key in keys:
        if key == "fps_id":
            ...
            batch[key] = repeat(value_dict[key], "1 ... -> b ...", b=N[1])
